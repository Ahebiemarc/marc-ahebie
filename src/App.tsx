...
import { Github, Linkedin, Mail, Smartphone, MapPin, Download, Send } from 'lucide-react';
        ...
        <section id="about" ref={sectionRefs.about} className="py-20">
          <div className="container mx-auto px-4 flex flex-col md:flex-row items-center gap-10">
            <div className="md:w-1/3 text-center">
              <img src="https://placehold.co/400x400/334155/FFFFFF?text=A.M.A" alt={portfolioData.name} className="rounded-full mx-auto shadow-lg border-4 border-cyan-500" />
            </div>
      ...
      <footer className="bg-gray-900 border-t border-gray-800 py-8">
        <div className="container mx-auto px-4 text-center text-gray-400">
          <div className="flex justify-center space-x-6 mb-4">
            <a href={portfolioData.socials.github} target="_blank" rel="noopener noreferrer" className="hover:text-cyan-400 transition-colors">
              <Github size={32} />
            </a>
            <a href={portfolioData.socials.linkedin} target="_blank" rel="noopener noreferrer" className="hover:text-cyan-400 transition-colors">
              <Linkedin size={32} />
            </a>
            <a href={`mailto:${portfolioData.email}`} className="hover:text-cyan-400 transition-colors">
              <Mail size={32} />
            </a>
          </div>
